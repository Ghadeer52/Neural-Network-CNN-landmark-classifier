...
# YOUR CODE HERE
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",  # Path to the train dataset
        transform=data_transforms["train"]  # Apply train transform
    )
    ...
    valid_data = datasets.ImageFolder(
        base_path / "train",  # Same path, but for validation
        transform=data_transforms["valid"]  # Apply validation transform
    )
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
        test_data,
        batch_size=batch_size,
        sampler=test_sampler,  # You can use test_sampler if limit is applied
        shuffle=False,  # Shuffle should be False for the test set
        num_workers=num_workers,
    )
